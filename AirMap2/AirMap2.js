...
angular.module('AirMap2').config(function($routeProvider) {
    ...
    $routeProvider.when('/AirMap2/:sensor*',{templateUrl: 'AirMap2/partial/AirMap2/AirMap2.html'});
    $routeProvider.when('/AirMap2',{templateUrl: 'AirMap2/partial/AirMap2/AirMap2.html'});
